...
resource "aws_instance" "server" {
  ...
  connection {
    ...
    private_key = file("~/.ssh/id_ed25519")  #private key path C:\Users\Ashfaq Ahmed\.ssh
    host        = self.public_ip
  }
 ...
 provisioner "local-exec" {
  ...
  provisioner "file" {
    source      = "file1"  # Replace with the path to your local file
    destination = "/home/ubuntu/file1"  # Replace with the path on the remote instance
  }
